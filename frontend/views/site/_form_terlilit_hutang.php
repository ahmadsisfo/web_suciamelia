...
<div class="row">
    <div class="col-md-6">
        <?php if($zakat->upload_surat_keterangan_hutang){
            $url = Url::toRoute(['pict','id'=>$zakat->formulir_pendaftaran_id,'field'=>'upload_surat_keterangan_hutang']);
            echo'<div class="card-avatar picture"><a target="_blank" href="'.$url.'"><img src="'.$url.'" style="width:100px" /></a></div>';
        } ?>
        <?= $form->field($zakat, 'upload_surat_keterangan_hutang')->widget(kartik\file\FileInput::classname(), [
