	    ...
	    <div class="section section-download" id="downloadSection">
	        <div class="container">
				...
				<div class="row text-center">
					<div class="col-md-8 col-md-offset-2">
	                    <h2>Want more?</h2>
	                    <h4>We've just launched <a href="http://demos.creative-tim.com/material-kit-pro/presentation.html?ref=utp-mk-demos" target="_blank">Material Kit PRO</a>. It has a huge number of components, sections and example pages. Start Your Development With A Badass Bootstrap UI Kit inspired by Material Design.</h4>
	                </div>
					<div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4">
						<a href="http://demos.creative-tim.com/material-kit-pro/presentation.html?ref=utp-mk-demos" class="btn btn-upgrade btn-lg" target="_blank">
	            ...
	            <div class="row sharing-area text-center">
						...
						<button id="googlePlus" class="btn btn-raised btn-google-plus">
	                        <i class="fa fa-google-plus"></i>
	                        Share
	                    </button>
...
<script type="text/javascript">
		...
		$().ready(function(){
			...
			$('#twitter').sharrre({
		      ...
		      url: 'http://demos.creative-tim.com/material-kit/index.html'
		    });
			...
			template: '<i class="fa fa-google-plus"></i> Share',
			url: 'http://demos.creative-tim.com/material-kit/index.html'
			});
