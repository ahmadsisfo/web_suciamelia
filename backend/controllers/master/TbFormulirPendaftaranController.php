...
use backend\models\master\TbFormulirPendaftaranSearch;
...
/**
 * TbFormulirPendaftaranController implements the CRUD actions for TbFormulirPendaftaran model.
 */
class TbFormulirPendaftaranController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all TbFormulirPendaftaran models.
     * @return mixed
     */
    ...
    /**
     * Creates a new TbFormulirPendaftaran model.
    ...
    {
        $model = new UserBiasa();
        $model->setScenario(UserBiasa::SCENE_CREATE); 
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            try {
                if($model->save()){
                    $transaction->commit();                     
                    return $this->redirect(['update', 'id' => $model->tbFormulirPendaftaran->id]);
                } 
            } catch (\Exception $exc) {               
    ...
    /**
     * Updates an existing TbFormulirPendaftaran model.
    ...
    /**
     * Deletes an existing TbFormulirPendaftaran model.
    ...
    /**
     * Finds the TbFormulirPendaftaran model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TbFormulirPendaftaran the loaded model
